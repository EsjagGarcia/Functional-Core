...
fix = (Sintax.App (Sintax.Fn "f" (Sintax.Fn "x" (Sintax.App (Sintax.V "f") (Sintax.App (Sintax.V "x") (Sintax.V "x"))))) (Sintax.Fn "x" (Sintax.App (Sintax.V "f") (Sintax.App (Sintax.V "x") (Sintax.V "x")))))
...
parserExprToExpr (Parser.RecurFn f x e) = Sintax.App (Sintax.Fn x (parserExprToExpr e)) fix
